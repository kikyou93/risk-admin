 ...
 */
package com.zegopay.risk.modules.quartz.rest;
...
public class QuartzJobController {
    ...
    @ApiOperation("查询定时任务")
    @GetMapping
    @PreAuthorize("@risk.check('timing:list')")
    ...
    @ApiOperation("新增定时任务")
    @PostMapping
    @PreAuthorize("@risk.check('timing:add')")
    ...
    @ApiOperation("修改定时任务")
    @PutMapping
    @PreAuthorize("@risk.check('timing:edit')")
    ...
    @ApiOperation("删除定时任务")
    @DeleteMapping
    @PreAuthorize("@risk.check('timing:del')")
