...
public class ${className}Controller {
    ...
    @PreAuthorize("@risk.check('${changeClassName}:list')")
    ...
    @PreAuthorize("@risk.check('${changeClassName}:add')")
    ...
    @PreAuthorize("@risk.check('${changeClassName}:edit')")
    ...
    @PreAuthorize("@risk.check('${changeClassName}:del')")
    @DeleteMapping
